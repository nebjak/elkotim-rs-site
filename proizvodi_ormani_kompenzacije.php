...
<html>
  <head>
    ...
    <title>Ormani kompenzacije :: Proizvodi <?= WEBSITE_TITLE ?></title>
  ...
  <body>
    ...
    <div class="container_12" id="page">
      ...
      <div class="grid_8" id="content_box">
        <h2>Ormani kompenzacije</h2>
        <p>
          <?= gen_gallery('assets/img/proizvodi/ormani_kompezacije', 'Orman kompenzacije') ?>
        </p>
      </div>
