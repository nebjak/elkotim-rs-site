...
<html>
  <head>
    ...
    <title>Industrijski ormani :: Proizvodi <?= WEBSITE_TITLE ?></title>
  ...
  <body>
    ...
    <div class="container_12" id="page">
      ...
      <div class="grid_8" id="content_box">
        <h2>Industrijski ormani</h2>
        <p>
          <?= gen_gallery('assets/img/proizvodi/industriski_ormani', 'Industrijski orman') ?>
        </p>
      </div>
