...
<html>
  <head>
    ...
    <title>Modularni slobodnostojeći ormani :: Proizvodi <?= WEBSITE_TITLE ?></title>
  ...
  <body>
    ...
    <div class="container_12" id="page">
      ...
      <div class="grid_8" id="content_box">
        <h2>Modularni slobodnostojeći ormani</h2>
        <p>
          <?= gen_gallery('assets/img/proizvodi/modularni_slobodnostojeci_ormani', 'Modularni slobodnostojeći orman') ?>
        </p>
      </div>
