...
<html>
  <head>
    ...
    <title>Slobodnostojeći ormani :: Proizvodi <?= WEBSITE_TITLE ?></title>
  ...
  <body>
    ...
    <div class="container_12" id="page">
      ...
      <div class="grid_8" id="content_box">
        <h2>Slobodnostojeći ormani</h2>
        <p>
          <?= gen_gallery('assets/img/proizvodi/slobodnostojeci_ormani', 'Slobodnostojeći orman') ?>
        </p>
      </div>
